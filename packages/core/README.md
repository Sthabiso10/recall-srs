...
The scheduling engine: FSRS, the card and deck model, review queues and study sessions. Zero runtime dependencies, no React, no DOM.
...
scheduler.retrievabilityOf(updated); // recall probability, 0 to 1
```
